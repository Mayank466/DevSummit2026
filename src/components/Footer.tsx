      ...
      <div className="footer-container">
        <div className="footer-main">
          ...
          <div className="footer-links">
            <a href="https://x.com/Devsummit2026?s=20" className="social-link"><img src={`${import.meta.env.BASE_URL}x.webp`} alt="X (Twitter)" className="footer-social-icon icon-x" loading="lazy" /></a>
            <a href="https://www.linkedin.com/company/devsummit-2026/" className="social-link"><img src={`${import.meta.env.BASE_URL}ln.webp`} alt="LINKEDIN" className="footer-social-icon icon-linkedin" loading="lazy" /></a>
            <a href="https://www.instagram.com/devsummit2026/" className="social-link"><img src={`${import.meta.env.BASE_URL}ig.webp`} alt="INSTAGRAM" className="footer-social-icon icon-instagram" loading="lazy" /></a>
            <a href="https://discord.gg/rmcpwX27MG" className="social-link"><img src={`${import.meta.env.BASE_URL}ds.webp`} alt="DISCORD" className="footer-social-icon icon-discord" loading="lazy" /></a>
          </div>
        </div>
      </div>
    </footer>
