    ...
    <section id="prizes" className="section prizes-section">
      <div className="section-container">
        ...
        <p className="prize-description scroll-animate">
          Compete for exciting prizes, goodies, and industry-level connections. Every participant goes home with something special!
        </p>
        ...
        <div className="prizes-grid">
          <div className="prize-card scroll-animate" style={{ "--delay": "0.1s" } as React.CSSProperties}>
            <div className="prize-card-header">
              ...
              <h4 className="prize-card-title">CASH REWARDS</h4>
            </div>
            <div className="prize-card-body">
              <p className="prize-card-desc">Amazing cash rewards for top performing teams</p>
          ...
          <div className="prize-card scroll-animate" style={{ "--delay": "0.2s" } as React.CSSProperties}>
            <div className="prize-card-header">
              ...
              <h4 className="prize-card-title">GOODIES & SWAGS</h4>
            </div>
            <div className="prize-card-body">
              <p className="prize-card-desc">Exciting goodies and swag for top performers</p>
            </div>
          </div>
          ...
          <div className="prize-card scroll-animate" style={{ "--delay": "0.3s" } as React.CSSProperties}>
            <div className="prize-card-header">
              ...
              <h4 className="prize-card-title">CERTIFICATES</h4>
            </div>
            <div className="prize-card-body">
              <p className="prize-card-desc">Official certificates for all participants</p>
            </div>
          </div>
        </div>
      </div>
